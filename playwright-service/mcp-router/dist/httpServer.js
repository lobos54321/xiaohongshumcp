...
app.get('/api/xiaohongshu/login/status', async (req, res) => {
    try {
        ...
        const forceQr = req.query.force_qr === '1' || req.query.mode === 'strict';
        if (!userId) {
        ...
        const result = await processManager.callTool(userId, '/api/v1/login/status', 'GET');
        res.json(result);
    }
    catch (error) {
...
app.get('/api/xiaohongshu/login/qrcode', async (req, res) => {
    try {
        ...
        const result = await processManager.callTool(userId, '/api/v1/login/qrcode', 'GET');
        res.json(result);
    }
    catch (error) {
        res.status(500).json({ error: error.message });
...
app.get('/api/xiaohongshu/login/verification-qrcode', async (req, res) => {
    try {
        ...
        const result = await processManager.callTool(userId, '/api/v1/login/verification-qrcode', 'GET');
        res.json(result);
    }
    catch (error) {
        res.status(500).json({ error: error.message });
...
app.post('/api/xiaohongshu/publish', async (req, res) => {
    try {
        ...
        const result = await processManager.callTool(userId, '/api/v1/publish', 'POST', req.body);
        res.json(result);
    }
    catch (error) {
        res.status(500).json({ error: error.message });
...
app.post('/api/xiaohongshu/publish/video', async (req, res) => {
    try {
        ...
        const result = await processManager.callTool(userId, '/api/v1/publish_video', 'POST', req.body);
        res.json(result);
    }
    catch (error) {
        res.status(500).json({ error: error.message });
...
app.get('/api/xiaohongshu/feeds/search', async (req, res) => {
    try {
        ...
        const result = await processManager.callTool(userId, '/api/v1/feeds/search', 'GET', { keyword });
        res.json(result);
    }
    catch (error) {
        res.status(500).json({ error: error.message });
...
app.get('/api/xiaohongshu/feeds/list', async (req, res) => {
    try {
        ...
        const result = await processManager.callTool(userId, '/api/v1/feeds/list', 'GET');
        res.json(result);
    }
    catch (error) {
        res.status(500).json({ error: error.message });
...
app.post('/api/xiaohongshu/logout', async (req, res) => {
    try {
        ...
        try {
            ...
            const deleteResponse = await axios.default.post(`${backendUrl}/agent/xiaohongshu/delete-cookies-from-db`, { userId }, { timeout: 10000, headers: { 'Content-Type': 'application/json' } });
